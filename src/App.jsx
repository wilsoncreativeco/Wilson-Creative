    ...
    <>
      ...
      <section id="work" className="section work">
        ...
        <div className="work-grid">
          ...
          <div className="work-item">Coming Soon</div>
          <div className="work-item">Coming Soon</div>
          <div className="work-item">Coming Soon</divGreat catch. Yes — that pasted assistant sentence inside your JSX is exactly what broke the build.

If you want zero risk, replace your entire `src/App.jsx` with this clean file:
