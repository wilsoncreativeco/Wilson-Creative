...
const services = [
  {
    ...
    backPoints: [
      '100% custom code — no templates ever',
      'Mobile-first, lightning-fast performance',
      'Full SEO setup from day one',
      'Contact forms, click-to-call & analytics',
  ...
  },
  {
    ...
    backPoints: [
      ...
      'RAW + colour-graded footage',
      'Property, events & brand shoots',
      'Hero video edits for your site',
      'Brisbane & surrounds',
    ],
  },
  {
    ...
    backPoints: [
      ...
      'Shot lists & creative direction included',
  ...
  },
  {
    ...
    backTitle: "What's coming",
    backPoints: [
      'Reels, carousels & static content',
            ...
            <div className="sc-wrapper" key={s.num}>
              <div className={`sc-flipper ${flippedCard === s.num ? 'flipped' : ''}`}>
                ...
                <div className="sc-back">
                  <button className="sc-back-close" onClick={() => setFlippedCard(null)} aria-label="Go back">
                    ← Back
                  </button>
            ...
            return (
              <article className="pcard" role="listitem" key={w.src}>
                ...
                >
                  ...
                  {isLive && !isReady && (
                    <div className="pcard-loading" aria-hidden="true">
                      <span />
                    </div>
                  )}

                  {isLive && (
                    <div className="pcard-live" aria-hidden="true">
                      <iframe
                        src={w.src}
                        title={w.title}
                        loading="lazy"
